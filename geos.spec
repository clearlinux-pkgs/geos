...
Version  : 3.11.1
Release  : 12
URL      : https://github.com/libgeos/geos/archive/3.11.1/geos-3.11.1.tar.gz
Source0  : https://github.com/libgeos/geos/archive/3.11.1/geos-3.11.1.tar.gz
...
%prep
%setup -q -n geos-3.11.1
cd %{_builddir}/geos-3.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672173784
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libgeos.so.3.11.1
/usr/lib64/libgeos_c.so
/usr/lib64/libgeos_c.so.1
/usr/lib64/libgeos_c.so.1.17.1
